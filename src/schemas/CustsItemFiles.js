...
// --- Begin: Customers Item Files Schema --- //
const schema = new Schema({
  _id: {type: String, default: uuidv4()},
  citd: {type: String, ref: config.collCustsItemDtls, required: true}, // Customers Item Details - Record ID
...
schema.index({vndrOrg: 1, citd: 1, voiCode: 1, fdt: 1, path: 1}, {unique: true});
schema.index({delFlag: -1, fSeq: 1, cDtNum: -1, uDtNum: -1});

module.exports = mongoose.model(config.collCustsItemFiles, schema);
// --- End: Customers Item Files Schema --- //
