...
app.use((err, req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
   ...
   res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With, content-type, kmvcatoken', 'apikey', 'kmvcuiinfo');
  
   // Response headers you wish to Expose
   res.setHeader('Access-Control-Expose-Headers', 'X-Requested-With, content-type, kmvcatoken');
